...
from grongier.dacite.exceptions import ForwardReferenceError
from grongier.dacite.types import is_optional
...
def create_instance(data_class: Type[T], init_values: Data, post_init_values: Data, unexpected_fields: Data) -> T:
    instance = data_class(**init_values)
    for key, value in post_init_values.items():
        setattr(instance, key, value)
    for key, value in unexpected_fields.items():
        setattr(instance, key, value)
    return instance
