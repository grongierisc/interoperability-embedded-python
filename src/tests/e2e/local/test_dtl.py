...
TRANSFORM_TEST_CASES = [
    ('{"string":"Foo", "integer":42}', 'fixtures.message.SimpleMessage', 'UnitTest.SimpleMessageGet', 'Foo'),
    ('{"post":{"Title":"Foo"}, "string":"bar", "list_str":["Foo","Bar"]}', 'fixtures.message.ComplexMessage', 'UnitTest.ComplexGet', 'Foo'),
    ('{"post":{"Title":"Foo"}, "list_post":[{"Title":"Bar"},{"Title":"Foo"}]}', 'fixtures.message.ComplexMessage', 'UnitTest.ComplexGetList', 'Foo'),
]
