...
class TestLocalDirectorDelegation(unittest.TestCase):
    ...
    @patch("iop.runtime.director._Director.get_default_production", return_value="MyProd")
    def test_get_default_production(self, mock):
        result = self.d.get_default_production()
        mock.assert_called_once_with()
        self.assertEqual(result, "MyProd")

    @patch("iop.runtime.director._Director.set_default_production")
    ...
    @patch("iop.runtime.director._Director.list_productions", return_value={"A": {}})
    def test_list_productions(self, mock):
        result = self.d.list_productions()
        mock.assert_called_once_with()
        self.assertEqual(result, {"A": {}})

    @patch("iop.runtime.director._Director.status_production", return_value={"status": "running"})
    ...
    @patch("iop.runtime.director._Director.log_production_top")
    def test_log_production_top(self, mock):
        self.d.log_production_top(25)
        mock.assert_called_once_with(25)

    @patch("iop.runtime.director._Director.log_production")
    ...
    @patch("iop.runtime.director._Director.test_component", return_value="response")
    ...
    @patch("iop.migration.utils._Utils.export_production", return_value='{"MyApp.Production": {}}')
